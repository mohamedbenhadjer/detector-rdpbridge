"""
Smoke test: Firefox timeout error
Tests that the hook works with Firefox (no debug port).
"""
from playwright.sync_api import sync_playwright
import time

def test_firefox_timeout():
    print("Starting Firefox timeout test...")
    ...
    with sync_playwright() as p:
        ...
        print("✓ Test completed successfully (Firefox, no debug port)")
        browser.close()

if __name__ == "__main__":
    test_firefox_timeout()
